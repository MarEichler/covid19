...
source("script/plot/state_14days.R") #creates facet_map of states' raw gf for past 14 days 
```
...
It turns out in this case it does not make make a significant difference!  Even when looking at the growth factor based on the 14-day moving average of new cases (smoothing over the cyclical nature of new cases reporting) the result is a growth factor, $\text{GF}_{14}$ that is not deviating from 1.  
