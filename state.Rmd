...
ggplot(last14days_facet_data, aes(date, case_MA7_PC_100k)) + 
    ...
    facet_geo(~geo, grid = "us_state_grid2" , labeller = adjust_labels, scales = "fixed") +
    #scale_fill_manual (name = "Trend of 7-Day Moving Average", values = c(mye_green, mye_red)) + 
    scale_color_manual(name = "Trend of 7-Day Moving Average", values = c(mye_green, mye_red)) + 
    scale_x_date(      name = NULL, expand = c(0, 0), breaks = NULL) + 
    scale_y_continuous(
        name = NULL
      , expand = c(0, 0)
